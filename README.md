...
git clone https://github.com/AstroIshu/GangaMitra
cd GangaMitra
...
python simulation_with_robot.py
...
- 📊 Optional: Run dashboard.py for performance metrics
